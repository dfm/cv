...
\item[{\color{numcolor}\scriptsize7}] Angus, Ruth, Morton, Timothy, Aigrain, Suzanne, \textbf{Foreman-Mackey, Daniel}, \& Rajpaul, Vinesh, 2017, Inferring probabilistic stellar rotation periods using Gaussian processes (\arxiv{1706.05459}) [\href{http://adsabs.harvard.edu/abs/2017arXiv170605459A}{2 citations}]

\item[{\color{numcolor}\scriptsize6}] Montet, Benjamin T., Tovar, Guadalupe, \& \textbf{Foreman-Mackey, Daniel}, 2017, Long Term Photometric Variability in Kepler Full Frame Images: Magnetic Cycles of Sun-Like Stars (\arxiv{1705.07928}) [\href{http://adsabs.harvard.edu/abs/2017arXiv170507928M}{4 citations}]

\item[{\color{numcolor}\scriptsize5}] \textbf{Foreman-Mackey, Daniel}, Agol, Eric, Ambikasaran, Sivaram, \& Angus, Ruth, 2017, Fast and scalable Gaussian process modeling with applications to astronomical time series (\arxiv{1703.09710}) [\href{http://adsabs.harvard.edu/abs/2017arXiv170309710F}{6 citations}]
