\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 1069 stars / 385 forks \\
...
\item \href{https://github.com/daft-dev/daft}{{\bf daft}} --- 566 stars / 111 forks \\
Render probabilistic graphical models using matplotlib \href{https://docs.daft-pgm.org}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 300 stars / 183 forks \\
Make some beautiful corner plots \href{http://corner.readthedocs.io}{[docs]}

\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 111 stars / 31 forks \\
