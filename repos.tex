\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 1063 stars / 380 forks \\
...
\item \href{https://github.com/daft-dev/daft}{{\bf daft}} --- 553 stars / 108 forks \\
Render probabilistic graphical models using matplotlib \href{https://docs.daft-pgm.org}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 290 stars / 181 forks \\
Make some beautiful corner plots \href{http://corner.readthedocs.io}{[docs]}

\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 106 stars / 29 forks \\
