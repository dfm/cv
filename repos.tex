\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 942 stars / 349 forks \\
...
\item \href{https://github.com/daft-dev/daft}{{\bf daft}} --- 478 stars / 102 forks \\
Render probabilistic graphical models using matplotlib \href{http://daft-pgm.org}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 240 stars / 156 forks \\
Make some beautiful corner plots \href{http://corner.readthedocs.io}{[docs]}

\item \href{https://github.com/dfm/exoplanet}{{\bf exoplanet}} --- 58 stars / 17 forks \\
