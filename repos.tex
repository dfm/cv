\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 1083 stars / 384 forks \\
...
\item \href{https://github.com/dfm/celerite}{{\bf celerite}} --- 146 stars / 35 forks \\
Scalable 1D Gaussian Processes in C++, Python, and Julia \href{http://celerite.rtfd.io}{[docs]}

\item \href{https://github.com/daft-dev/daft}{{\bf daft}} --- 576 stars / 111 forks \\
Render probabilistic graphical models using matplotlib \href{https://docs.daft-pgm.org}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 307 stars / 184 forks \\
Make some beautiful corner plots \href{http://corner.readthedocs.io}{[docs]}

\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 114 stars / 32 forks \\
