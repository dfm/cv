...
\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 391 stars / 203 forks \\
...
\item \href{https://github.com/daft-dev/daft}{{\bf daft}} --- 630 stars / 116 forks \\
Render probabilistic graphical models using matplotlib \href{https://docs.daft-pgm.org}{[docs]}

\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 169 stars / 45 forks \\
