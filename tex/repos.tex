\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 1123 stars / 391 forks \\
The Python ensemble sampling toolkit for affine-invariant MCMC \href{https://emcee.readthedocs.io}{[docs]}

\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 123 stars / 35 forks \\
Fast {\&} scalable MCMC for all your exoplanet needs!  \href{https://docs.exoplanet.codes}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 332 stars / 187 forks \\
...
\item \href{https://github.com/dfm/celerite}{{\bf celerite}} --- 156 stars / 35 forks \\
