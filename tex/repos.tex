\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 1184 stars / 402 forks \\
The Python ensemble sampling toolkit for affine-invariant MCMC \href{https://emcee.readthedocs.io}{[docs]}

\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 148 stars / 41 forks \\
Fast {\&} scalable MCMC for all your exoplanet needs!  \href{https://docs.exoplanet.codes}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 367 stars / 196 forks \\
...
\item \href{https://github.com/daft-dev/daft}{{\bf daft}} --- 612 stars / 115 forks \\
