\item \href{https://github.com/dfm/emcee}{{\bf emcee}} --- 1244 stars / 422 forks \\
The Python ensemble sampling toolkit for affine-invariant MCMC \href{https://emcee.readthedocs.io}{[docs]}

\item \href{https://github.com/dfm/corner.py}{{\bf corner.py}} --- 402 stars / 204 forks \\
...
\item \href{https://github.com/exoplanet-dev/exoplanet}{{\bf exoplanet}} --- 170 stars / 48 forks \\
Fast {\&} scalable MCMC for all your exoplanet needs!  \href{https://docs.exoplanet.codes}{[docs]}

\item \href{https://github.com/exoplanet-dev/celerite2}{{\bf celerite2}} --- 49 stars / 6 forks \\
